...
const RemoveProfileMessage = props => {
  const {setModalVisible, handleRemove, text, shortText} = props;
  return (
      ...
      <Modal animationType="slide" transparent={true}>
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.conifrmtext}>{shortText}</Text>
...
export default RemoveProfileMessage;
