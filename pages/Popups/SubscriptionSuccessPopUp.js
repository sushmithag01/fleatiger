...
const SubscriptonSuccessPopUp = props => {
  const {setSuccessPopUp, successPopUp} = props;
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Pressable
              ...
              onPress={() => setSuccessPopUp(!successPopUp)}>
            ...
            <Text style={styles.modalText}>
              Thank You for purshasing subscription plan.
            </Text>
          </View>
        </View>
      </Modal>
