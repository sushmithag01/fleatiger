...
const ActivityNameType = props => {
  const {setShowActivityName, ShowActivityName} = props;
  ...
  const handleGoto = () => {
    ...
    setShowActivityName(!ShowActivityName);
  };
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Pressable
              ...
              onPress={() => setShowActivityName(!ShowActivityName)}>
            ...
            <Text style={styles.modalText}>
              Please add activity name and type
            </Text>

            <TouchableOpacity
              onPress={() => handleGoto()}
              style={styles.bluebtnsmallTrack}>
              <Text style={styles.bluebtnsmalltexttracker}>
                Go to Edit activity
              </Text>
            </TouchableOpacity>
          </View>
...
export default ActivityNameType;
