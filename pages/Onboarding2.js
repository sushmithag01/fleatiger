...
import {Onboarding2HeaderLeft} from '../navigation/CustomBackNavigation';
...
const Onboarding2 = ({navigation}) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <Onboarding2HeaderLeft navigation={navigation} />,
    });
    if (isFocused) {
      getAddStatus();
      GetDropdowndata();
  ...
  const handleChange = (value, event) => {
    ...
    if (value == 'petName') {
      setPetName(event.nativeEvent.text.trimStart());
      if (event.nativeEvent.text.trimStart().length != 0) {
        setPetNameErr('');
      } else {
    ...
    <>
      <ScrollView style={styles.fleamain} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.skiptext}>Skip</Text>
          ...
          value={petName}               
          onChange={(event) => {handleChange("petName", event) }}
          ref={refInput}
           />
        <TouchableOpacity onPress={()=>handleChangeclick()}>
            ...
            <TouchableOpacity onPress={() => setIssVisible(true)}>
              <View style={styles.editnamemain}>
                <Text style={styles.editnametext}>
                  {!IsSubmit ? (
                    <Text>
                      Name<Text style={{color: '#f00732'}}>*</Text>
                    </Text>
                  ) : (
                    petNameText
                  )}
            ...
            <View style={styles.inputmain}>
              <View style={[styles.labelContainer, styles.selecttext]}>
                <Text style={styles.label}>
                  Breed<Text style={{color: '#f00732'}}>*</Text>
                </Text>
              </View>
          ...
          <View style={styles.inputmain}>
            <View style={[styles.labelContainer, styles.selecttext]}>
              <Text style={styles.label}>
                Sex<Text style={{color: '#f00732'}}>*</Text>
              </Text>
            </View>
            <View style={styles.inputContainerDrop}>
              <Dropdown
