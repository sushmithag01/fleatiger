...
const AddToysList = ({navigation,item,toysSelceted,setToysSelected,data,setData}) => {
  ...
  return (
    <>
      <View style={styles.selectswitch}>
        <Text style={styles.switchtext}>{item.toy_title_name}</Text>
