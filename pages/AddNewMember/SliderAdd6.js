...
import {SliderAdd6HeaderLeft} from '../../navigation/CustomBackNavigation';

const SliderAdd6 = ({navigation}) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <SliderAdd6HeaderLeft navigation={navigation} />,
    });
    if (isFocused) {
      getAddStatus();
    }
  ...
  const handleNext = async () => {
    if(ImeiNumber){
      ...
      navigation.navigate('SliderAdd7')
    }
