...
import {SliderAdd3HeaderLeft} from '../../navigation/CustomBackNavigation';

const SliderAdd3 = ({navigation}) => {
  // feilds
  ...
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <SliderAdd3HeaderLeft navigation={navigation} />,
    });
    if (isFocused) {
      getName();
    }
  ...
  const handleNext = () => {
    if (birthday == 'Enter Birthday') {
      ...
      navigation.navigate('SliderAdd4');
    }
  };
  ...
  return (
    <>
     ...
     <TouchableOpacity onPress={()=>navigation.navigate('SliderAdd2')}>
        <Ionicons name="arrow-back" size={30} color="#B85A57"></Ionicons>
      </TouchableOpacity>
      <TouchableOpacity onPress={()=>navigation.navigate('SliderAdd4')}>
        ...
        <Image source={require('../../assets/fleatiger_App-Icon_Apple.png')}></Image>        
       </View> */}
