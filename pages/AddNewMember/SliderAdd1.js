...
import {SliderAdd1HeaderLeft} from '../../navigation/CustomBackNavigation';

const SliderAdd1 = ({navigation}) => {
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <SliderAdd1HeaderLeft navigation={navigation} />,
    });
  }, []);
    ...
    <>
      <SafeAreaView>
        ...
        <Ionicons name="arrow-back" size={30} color="#B85A57"></Ionicons>
          ...
          <View>
            <Text style={styles.createacc}>Add a new profile</Text>
          </View>
          <View style={styles.space20}></View>
          ...
          <Text style={styles.onboardtext}>
            Let’s add a new member to the family!
          </Text>
