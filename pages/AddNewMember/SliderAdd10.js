...
import {SliderAdd10HeaderLeft} from '../../navigation/CustomBackNavigation';

const SliderAdd10 = ({navigation}) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <SliderAdd10HeaderLeft navigation={navigation} />,
    });
    if (isFocused) {
      getName();
      getSliderData();
  ...
  const handleNext = () => {
    ...
    navigation.navigate('SliderAdd11');
  };
