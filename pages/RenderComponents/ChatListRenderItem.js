...
function ChatListRenderItem({ item, chatType }) {
    ...
    const notificationHilightHandler = async () => {
        ...
        console.log("gethiglight",gethiglight)
    ...
    const handleFromFirebaseDelete = async data => {
        console.log('deleteChatRes', data);
        setLoading(true);
    ...
    return (
        ...
        <>
            <TouchableOpacity onPress={() => handleChatRoom(item?.item, chatType)}>
                <View
                    style={[
                        styles.logmain,
                        styles.marginhz20,
                    ...
                    <View style={[styles.logmain2, styles.marbottom15]}>
                        <TouchableOpacity
                            ...
                            <Image
                                source={
                                    item?.item?.pet_image_path ? { uri: item?.item?.pet_image_path } :
                    ...
                    <TouchableOpacity onPress={() => handleFromFirebaseDelete(item)}>
                        <View>
                            <Ionicons name="trash" size={20} color="#B85A57"></Ionicons>
                        </View>
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
