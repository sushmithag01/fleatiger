...
import {FriendProfileAPI, chatHighlightApi} from './API/ApiCalls';
...
const FriendProfile = ({navigation, route}) => {
  ...
  const GetProfileInfo = async () => {
    ...
    const payload = {
      ...
      pet_id: parseInt(friendId),
    };
    const Response = await FriendProfileAPI(payload);
  ...
  return (
    <>
      ...
      <View style={styles.mainpage}>
        ...
        {/* <TopHeader /> */}
        {/* start */}
        <View style={[styles.prodemain, styles.marhoz25]}>
          <View>
            <View style={styles.space20}></View>
            {/* profile */}
            ...
            <View style={styles.editnamemain}>
              <Text style={styles.editnametext}>{data.pet_name}</Text>
            </View>
            <Text style={styles.familytext}>My Friend</Text>
          </View>
          ...
          <View>
            <View style={[styles.prodemain]}>
              <View style={[styles.act1, styles.act4]}>
                ...
                <Text style={[styles.act5]}>{data?.gender}</Text>
              </View>
              <View style={[styles.act1, styles.act4]}>
                <Svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <View style={[styles.prodemain]}>
              <View style={[styles.act1, styles.act4, {width: 200}]}>
                <Svg
                  xmlns="http://www.w3.org/2000/svg"
                  id="icons-RZ_Weiss"
                  viewBox="0 0 50 50"
                ...
                <Text style={[styles.act5]} numberOfLines={2}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.homecardinner1}>
            <Text style={styles.homecardtext1}>{data.pet_name}'s Toybox</Text>
            <View style={styles.act1}>
              <Svg
                xmlns="http://www.w3.org/2000/svg"
                id="icons-RZ_Weiss"
