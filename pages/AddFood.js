...
import { AddFoodHeaderLeft } from '../navigation/CustomBackNavigation';
...
const AddFood = ({ navigation }) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerLeft: () => <AddFoodHeaderLeft navigation={navigation} data={data}/>,
    });
    if (isFocused) {
      getName()
      getSliderData()
    ...
    <>
      <ScrollView style={[styles.mainpage, styles.padhoz15]} showsVerticalScrollIndicator={false}>
        ...
        {/* <View style={styles.navheader}>
          <TouchableOpacity onPress={() => navigation.navigate('AddToys')}>
        ...
        <View>
          <Text style={[styles.createacc, styles.createacc1,{textAlign:"center"}]}>Add Food</Text>
