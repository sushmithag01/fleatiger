...
const PremiumSubscription = props => {
  ...
  const {
    handlePremierYearlySubscription,
    handlePremierMonthlySubscription,
    premiumPlanList,
    active_plan,
  } = props;
          ...
          <View style={styles.sub_whole}>
            <TouchableOpacity
              ...
              onPress={() => {
                if (Platform.OS === 'android') {
                  handlePremierYearlySubscription(
                    premiumPlanList[0].subscription_plan_id,
                  );
                } else {
                  handlePremierYearlySubscription(
                    premiumPlanList[0].ios_subscription_plan_id,
                  );
                }
              }}>
              <View
              ...
              {/* <Text style={{ color: '#495F75', textAlign: "center" }}>Current Plan</Text> */}
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.cardYearlyOuter}
              onPress={() => {
                if (Platform.OS === 'android') {
                  handlePremierMonthlySubscription(
                    premiumPlanList[1].subscription_plan_id,
                  );
                } else {
                  handlePremierMonthlySubscription(
                    premiumPlanList[1].ios_subscription_plan_id,
                  );
                }
              }}>
              <View
          ...
          <View style={styles.tick_sec}>
            ...
            <View>
              <Text style={styles.text_inner}>
                All the features of{' '}
                <Text style={styles.innerText}>STARTER</Text>
              </Text>
            </View>
          </View>
